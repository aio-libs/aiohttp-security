...
# -*- coding: utf-8 -*-
#
# aiohttp_security documentation build configuration file, created by
# sphinx-quickstart on Tue Apr  14 11:54:09 2015.
#
...
htmlhelp_basename = 'aiohttp_securitydoc'
...
latex_documents = [
    (master_doc, 'aiohttp_security.tex', 'aiohttp\\_security Documentation',
...
man_pages = [
    (master_doc, 'aiohttp_security', 'aiohttp_security Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'aiohttp_security', 'aiohttp_security Documentation',
     author, 'aiohttp_security', 'One line description of project.',
     'Miscellaneous'),
]
